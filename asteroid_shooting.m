% 1 July 2016
% Multiple shooting to approximate the reachable set about an asteroid

function [sol_output]= asteroid_shooting(x0_i,h0_i,beta_i,xcf,tf,constants)
...
parfor sol_index = 1:num_sims
    ...
    % call fsolve
    [xg,fval,exitflag,output] = fsolve(@(xg)objective(xg,Q, x0, phi_d,constants),xg,constants.optfsolve);
    ...
    [m, dmdx] = constraints_nodenom(xminus(:,end),phi_d,constants);
