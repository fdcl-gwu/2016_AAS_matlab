...
numsteps = 1e3;
[t1,state1_body] = ode113(@(t,state)ast_eoms(t,state,constants),linspace(0,cross_time_out1,numsteps),x0_out1,ode_options);
[t2,state2_body] = ode113(@(t,state)ast_eoms(t,state,constants),linspace(0,cross_time_out2,numsteps),x0_out2,ode_options);
...
text(state1_inertial(1,1),state1_inertial(1,2),state1_inertial(1,3),'Initial','HorizontalAlignment','right')
text(state2_inertial(1,1),state2_inertial(1,2),state2_inertial(1,3),'Target','HorizontalAlignment','left')
...
text(state1_body(1,1),state1_body(1,2),state1_body(1,3),'Initial','HorizontalAlignment','right')
text(state2_body(1,1),state2_body(1,2),state2_body(1,3),'Target','HorizontalAlignment','left')
