function [con, jac] = objective(xg, Q, x_0,phi_d,constants)
...
for seg = 2:num_seg-1
    ...
    [con_seg] = seq_newton(seg, x_i, h_i,Q, x_0,xm, hm,beta, h0, phi_d,constants); % compute stage con and jacobian
...
[con_seg] = seq_newton(1, x_i, h_i,Q, x_0,xm, hm, beta, h0,phi_d,constants);
con(1:2*num_states) = con_seg;


% compute for last stage
[con_seg] = seq_newton(num_seg, x_i, h_i,Q, x_0,xm, hm, beta, h0,phi_d,constants);
